                ...
                <div class="col-lg-12">
                    <div class="footer__text">
                        ...
                        <p>
                            ...
                            Tại đây, bạn sẽ tìm thấy những công thức nấu ăn ngon, dễ làm, phù hợp với khẩu vị người Việt, cùng những trải nghiệm ẩm thực thú vị và độc đáo.<br /> 
                            Hãy cùng MeFood khám phá thế giới ẩm thực đầy màu sắc và hấp dẫn nhé!</p>
                    ...
                    <div class="footer__copyright">
                        <p>
                            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved by MeFood
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="search-model">
        <div class="h-100 d-flex align-items-center justify-content-center">
            ...
            <form class="search-model-form">
                <input type="text" id="search-input" placeholder="Tìm kiếm đi...">
            </form>
        </div>
    </div>
    <!-- Search End -->
