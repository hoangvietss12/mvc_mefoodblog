...
<div class="container">
    <h1 class="my-4">Sửa danh mục bài viết</h1>
    <form action="<?php echo _WEB_ROOT_ADMIN . '/admin/category/update?id='. $category['id']; ?>" method="POST">
        <div class="mb-3">
            <label for="name" class="form-label">Tên danh mục:</label>
            <input type="text" class="form-control" id="name" aria-describedby="Category Name" name="name" value="<?php echo $category['name'] ?? ''; ?>">
